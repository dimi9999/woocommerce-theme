...
class Eh_Stripe_Checkout extends WC_Payment_Gateway {
	...
	public function process_payment( $order_id ) {
        ...
        $session_data = array(
            ...
            'success_url'=> home_url().'/?wc-ajax=eh_spg_stripe_checkout_order'.'&sessionid={CHECKOUT_SESSION_ID}'.'&order_id='.$order_id.'&_wpnonce='.wp_create_nonce('eh_checkout_nonce').'&createaccount='.$createaccount,
